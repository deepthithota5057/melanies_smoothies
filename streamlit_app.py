...
#convert snowflake dataframe to python pandas dataframe
...
if ingredients_list:
    ...
    for fruits_chosen in ingredients_list:
        ...
        st.write("https://my.smoothiefroot.com/api/fruit/"+"Blueberry")
        smoothiefroot_response = requests.get("https://my.smoothiefroot.com/api/fruit/"+"Blueberry")
